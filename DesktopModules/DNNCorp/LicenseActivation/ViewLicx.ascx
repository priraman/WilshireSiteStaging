...
<div class="dnnForm dnnViewLicx dnnClear" id="dnnViewLicx">
            ...
            <MasterTableView DataKeyNames="LicenseID">
                <Columns>
                    <dnnweb:DnnGridTemplateColumn HeaderText="LicenseType">
                        <ItemTemplate>
                            <%#GetLicenseType(Eval("Environment").ToString(), (string)Eval("Invoice") )%>   
                        </ItemTemplate>
    ...
    <div id="licxTabs" class="licxTabs" runat="server">
	    <div id="onlinetab" runat="server" class="ltOnline">
            ...
            <div id="divAccount" runat="server">
                <div class="dnnFormItem">
                    ...
                    <dnnweb:DnnComboBox ID="lstLicenseType" runat="server" />
                </div>
                <div class="dnnFormItem">
                    <dnn:label id="plMachine" runat="server" controlname="txtMachine" suffix=":" />                   
                    <dnnweb:DnnComboBox ID="lstServers" runat="server" />
                    <span id="LblSelectedServerAppName" runat="server" title="IIS Application" class="dnnRight" style="min-width: 16%" />
				    <div style="display:none" class="dnnFormItem">
                        <div class="dnnLabel"></div>					    
                        <dnnweb:DnnComboBox ID="lstServerAppNames" runat="server" />
				    </div>
                </div>
                <div class="dnnFormItem">
                    <dnn:label id="plAccount" runat="server" controlname="txtAccount" suffix=":" CssClass="dnnFormRequired" />
                ...
                <div class="dnnFormItem">
                    <dnn:label id="plInvoice" runat="server" controlname="txtInvoice" suffix=":"  CssClass="dnnFormRequired"/>
	    ...
	    <div id="manualtab" runat="server" class="ltManual" visible="false">
            ...
            <div class="dnnFormItem">
                <dnn:label id="plActivationKey" runat="server" controlname="txtActivationKey" suffix=":"  CssClass="dnnFormRequired"/>
	    ...
	    <div id="extendtab" runat="server" class="ltExtend" visible="false">
            <fieldset>
                ...
                <div class="dnnFormItem">
                     <dnn:label id="plEmail" runat="server" controlname="txtEmail" suffix=":" CssClass="dnnFormRequired" />
                ...
                <div class="dnnFormItem">
                    <dnn:label id="plFirstName" runat="server" controlname="txtFirstName" suffix=":" CssClass="dnnFormRequired" />
                ...
                <div class="dnnFormItem">
                    <dnn:label id="plLastName" runat="server" controlname="txtLastName" suffix=":" CssClass="dnnFormRequired" />
	    ...
	    <div id="activatetab" runat="server" class="ltActivate" visible="false">
            <fieldset>
                ...
                <div class="dnnFormItem">
                    <dnn:label id="plLicenseKey" runat="server" controlname="txtLicenseKey" suffix=":" CssClass="dnnFormRequired" />
