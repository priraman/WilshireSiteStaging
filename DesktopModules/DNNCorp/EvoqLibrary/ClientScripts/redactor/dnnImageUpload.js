...
RedactorPlugins.dnnImageUpload = {
    ...
    dnnUploadInit: function (el, options) {
        ...
        var $el = $('#' + el);
        var $dropArea = $('.redactor_droparea', $el.parent());
        if ($dropArea.length == 0) {
            this.droparea = $('<div class="redactor_droparea"></div>');
            this.droparea.append($('<div class="redactor_browse_to_upload onlyUpload">' + this.opts.curLang.browseToUploadText + '</div>'));
            $('#redactor_file').addClass('onlyUpload');
