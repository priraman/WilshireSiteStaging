...
(function ($) {
    ...
    $.dnnRedactor.opts = {
        ...
        langs: {
            en: {
                ...
                edit: 'Edit',
                // DNN Customised
                uploadStatusTitle: 'You selected the following image to upload',
                recentUploads: 'Recent Uploads',
                enterResourceUrl: 'Enter Resource URL <span class="example_url">(http://example.com/imagename.jpg)</span>',
                insertImage: 'Insert Image',
                advancedEditor: 'Advanced Editor',
                // END Customised

                // DNN imageUpload Customised
                uploadFile: 'Upload File',
                storedLocation: 'Stored Location',
                fromUrl: 'From URL',
                invalidFileMessage: 'You can only upload one of these types of image files: jpg,jpe,bmp,gif,png,jpeg,ico.',
                exceedLimit: 'File size bigger than ', // In dnnImageUpload: ... + maxFileSize/1000000 + ' Mb'
    ...
    Redactor.fn = $.dnnRedactor.prototype = {
        ...
        init: function (el, options) {
            ...
            // clonning options
            var opts = $.extend(true, {}, $.dnnRedactor.opts);
        ...
        // DNN customised - for clean code get
        ...
        buildBindKeyboard: function () {
            ...
            if (!this._documentClickEventHandler) {
                this._documentClickEventHandler = $.proxy(function(e) {
                    ...
                    var blockBlur = clickedElement.parents('.redactor_blockBlur').size() > 0
                        || clickedElement.parents('.redactor_box').size() > 0
                        || clickedElement.attr('id') == 'redactor_modal_overlay';
                    if (!blockBlur) {
            ...
            this.$editor.on('blur.redactor', $.proxy(function (e) {
                ...
                if (!$clickedElement.hasClass('redactor_toolbar')
                        && $clickedElement.parents('.redactor_toolbar').size() == 0
                        && $clickedElement.parents('.redactor_blockBlur').size() == 0
                        && $clickedElement.parents('.redactor_box').size() == 0
                        && $clickedElement.attr('id') != 'redactor_modal_overlay') {
        ...
        imageResizeControls: function ($image) {
            // DNN Customised
            if (!this.opts.allowImageEditor) return false;
            // END DNN Customised
        ...
        buildProgressBar: function () {
            ...
            if ($('#redactor-progress').size() != 0) {
                this.$progressBar = $('#evoq-redactor-progress');
                return;
            }
            // END DNN customsized
            ...
            // DNN customised
            this.$progressBar = $('<div id="evoq-redactor-progress"></div>');
            // END DNN customsized
        ...
        modalTemplatesInit: function () {
            $.extend(this.opts,
			{
                ...
                // DNN added id="redactor_link_url_label"
			    modal_link: String()
				+ '<section id="redactor-modal-link-insert">'
					+ '<select id="redactor-predefined-links" style="width: 99.5%; display: none;"></select>'
					+ '<label>URL</label>'
					+ '<input type="text" class="redactor_input" id="redactor_link_url" />'
					+ '<label id="redactor_link_url_label">' + this.opts.curLang.text + '</label>'
        ...
        modalShowOnMobile: function () {
            ...
            */
            /* DNN customised */
            var maxHeight = 0;
            var uiDialog = $('.ui-dialog.dnnFormPopup.dnnFormPopupMobileView:visible');
            if (uiDialog.length) maxHeight = uiDialog.height() + 50;
            else maxHeight = $('#Form').height() + 50;
            this.$redactorModal.css({
                position: 'absolute',
                top: '0',
                height: maxHeight,
        ...
        draguploadInit: function (el, options) {
            ...
            this.droparea.append($('<div class="redactor_drag_drop_text">' + this.opts.curLang.dragDropText + '</div>'));
            this.droparea.append($('<div class="redactor_or_text">' + this.opts.curLang.orText + '</div>'));
            this.droparea.append($('<div class="redactor_browse_to_upload">' + this.opts.curLang.browseToUploadText + '</div>'));

            setTimeout(function() {
                $('.redactor_browse_to_upload').off('click').on('click', function() {
                    $('#redactor_file').trigger('click');
                });
            }, 0);
        ...
        isMobile: function () {
            ...
            /* DNN customised */
            return /(iPhone|iPod|BlackBerry|Android)/.test(navigator.userAgent) || $('html').hasClass('mobileView');
            /* end DNN customised */
        },
        isIPad: function () {
    ...
    // LINKIFY
    $.dnnRedactor.fn.formatLinkify = function (protocol, convertLinks, convertImageLinks, convertVideoLinks, linkSize) {
        ...
        while (i--) {
            ...
            if (n.nodeType === 3) {
                ...
                $.dnnRedactor.fn.formatLinkify.call(n, protocol, convertLinks, convertImageLinks, convertVideoLinks, linkSize);
            }
        }
    };
