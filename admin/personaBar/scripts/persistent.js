            ...
            return {
                ...
                save: function (s, callback) {
                    ...
                    serviceFramework.postsilence('UpdateUserSettings', settings, function () {
                        ...
                        if (inIframe) {
                            if (window.parent.__personaBarUserSettings) {
                                $.extend(window.parent.__personaBarUserSettings, settings);
                            }
                        } else {
                            if (window.__personaBarUserSettings) {
                                $.extend(window.__personaBarUserSettings, settings);
                            }
                        }
